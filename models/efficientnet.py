...
def _efficientnet(model_name, pretrained=False, progress=True, num_classes=1000, norm_layer=None, map_location= torch.device('cuda'), **kwargs):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls[model_name], progress=progress, map_location=map_location)
